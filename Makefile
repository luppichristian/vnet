CC=clang
CFLAGS=-std=c23 -Wall -Wextra -pedantic -D_CRT_SECURE_NO_WARNINGS -Wno-deprecated-declarations -Ilib -Iprotocol -Itargets
ifneq ($(OS),Windows_NT)
CFLAGS+=-pthread
EXE=
else
...
COMMON_SOURCES := $(LIB_SOURCES) $(PROTOCOL_SOURCES)
