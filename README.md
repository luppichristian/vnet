...
- Router forwarding with connected/static routes, ACLs, NAT/PAT, DHCP relay, and VLAN subinterfaces
...
| [`docs/protocols`](docs/protocols/) | Ethernet through TCP, including scope versus real implementations |
